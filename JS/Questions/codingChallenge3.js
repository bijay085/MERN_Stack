...
console.log(`${dolphinsAverage} this is dolphin average \n`);
console.log(`${koalasAverage} this is koalas average \n`);


dolphinsAverage > koalasAverage && dolphinsAverage > 100 && koalasAverage > 100 && console.log("Dolphin's team wins.");

koalasAverage > dolphinsAverage  && dolphinsAverage > 100 && koalasAverage > 100 && console.log("Koalas's team wins.");

koalasAverage === dolphinsAverage && dolphinsAverage>100 && koalasAverage >100 && console.log("Noone wins, score draw.");
